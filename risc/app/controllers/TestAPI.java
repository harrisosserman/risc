...
public class TestAPI extends Controller {
    ...
    public static Result getTestMap(String id) {
        ...
        map.put(new JSONObject().put("owner", 1).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 2).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 3).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 3).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 2).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 1).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        map.put(new JSONObject().put("owner", 1).put("INFANTRY", 5).put("AUTOMATIC", 10).put("ROCKETS", 15).put("TANKS", 20).put("IMPROVEDTANKS", 25).put("PLANES", 30));
        ...
        additionalInfo.put(new JSONObject().put("owner", "harriso").put("level", 0).put("food", 35).put("technology", 10).put("additionalInfantry", 50));
